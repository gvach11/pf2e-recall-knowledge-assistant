...
| Critical Failure | Reveal **1 false** piece of info in the chosen category, presented with the same confidence/formatting as real info (player isn't told it's false). |
